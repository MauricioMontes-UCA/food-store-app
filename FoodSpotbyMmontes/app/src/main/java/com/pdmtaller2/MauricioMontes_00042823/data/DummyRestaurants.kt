package com.pdmtaller2.MauricioMontes_00042823.data
...
val restaurants = listOf<Restaurant>(
    Restaurant(
        ...
        categories = listOf("Mexicana", "Saludable"),
        menu = listOf(
    ...
    Restaurant(
        ...
        categories = listOf("Italiana", "Postres y Dulces"),
        menu = listOf(
    ...
    Restaurant(
        ...
        categories = listOf("Mexicana", "Postres y Dulces"),
        menu = listOf(
    ...
    Restaurant(
        ...
        categories = listOf("Italiana", "Rápida"),
        menu = listOf(
    ...
    Restaurant(
        ...
        categories = listOf("Asiática", "Rápida", "Saludable"),
        menu = listOf(
    ...
    Restaurant(
        ...
        categories = listOf("Postres y Dulces", "Bebidas", "Saludable"),
        menu = listOf(
    ...
    Restaurant(
        ...
        categories = listOf("Postres y Dulces", "Bebidas", "Asiática"),
        menu = listOf(
